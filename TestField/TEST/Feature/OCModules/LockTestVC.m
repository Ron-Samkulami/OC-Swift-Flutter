...
- (void)viewDidLoad {
    ...
    logButton.frame = CGRectMake(15, [[UIScreen mainScreen] bounds].size.height - 200, 100, 50);
    ...
    clearButton.frame = CGRectMake([[UIScreen mainScreen] bounds].size.width-115, [[UIScreen mainScreen] bounds].size.height - 200, 100, 50);
